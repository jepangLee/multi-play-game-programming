...
- 배포 이후 여러 주요 운영체제 및 프로그래밍 언어로 포팅 되어 사실상 네트워크 프로그램의 표준으로 여겨지고 있다.
   ...
   - af 
    ...
    - protocol
      ...
      - 사용값
        ...
        | 매크로 | 프로 소켓 종류 | 의미 | 
        | - | - | - |
        | IPPROTO_UDP | STREAM_DGRAM  | UDP 데이터 그램 패킷 |
...
3. 소켓 송수신 중단함수
    ...
    - how
      ...
      - SD_SEND를 지정하면 현재 전송 중인 데이터를 모두 전송한 뒤 FIN패킷을 보내 연결을 안전하게 닫고자 하는 것을 알려준다.
